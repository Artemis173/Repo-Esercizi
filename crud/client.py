...
while True:
    ...
    if comando=="1":
        ...
        jsonDataRequest = create_dati_cittadino()
    ...
    if comando=="2":
        api_url = base_api_url + "add_cittadino"
        jsonDataRequest = read_cittadini()
        response = requests.post(api_url,json=jsonDataRequest,verify=False,auth=HTTPBasicAuth(username,password))
        print(response.json())
        print(response.status_code)
        print(response.headers["Content-Type"])
    ...
    if comando=="3":
        api_url = base_api_url + "add_cittadino"
        jsonDataRequest = update_cittadini()
        response = requests.post(api_url,json=jsonDataRequest,verify=False,auth=HTTPBasicAuth(username,password))
        print(response.json())
        print(response.status_code)
        print(response.headers["Content-Type"])
    ...
    if comando=="4":
        api_url = base_api_url + "add_cittadino"
        jsonDataRequest = delete_cittadini()
        response = requests.post(api_url,json=jsonDataRequest,verify=False,auth=HTTPBasicAuth(username,password))
        print(response.json())
        print(response.status_code)
        print(response.headers["Content-Type"])
